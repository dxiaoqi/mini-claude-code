...
# 精确编辑
echo '用 FileEdit 把 test-output/hello.txt 里的 "World" 替换成 "Lino"' | npx tsx src/cli.ts -p
# 预期：精确替换成功
# 验证：cat test-output/hello.txt → "Hello Lino"
